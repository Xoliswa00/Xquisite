...
<a href="https://wa.me/{{ $wa }}?text={{ $msg }}"
   ...
   class="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#25D366] hover:bg-[#20b858] rounded-full shadow-lg flex items-center justify-center transition-transform hover:scale-110">
