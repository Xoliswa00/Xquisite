        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                <a href="{{ route('purchase-orders.create', ['from_reorder' => 1]) }}"
                   class="text-sm text-amber-400 hover:text-amber-300 bg-amber-900/20 border border-amber-800/50 px-4 py-2 rounded-lg">
                    From Reorder List
                </a>
                ...
                <tbody class="divide-y divide-slate-700">
                    @forelse($orders as $order)
                        ...
                        <tr class="hover:bg-slate-700/30">
                            <td class="px-4 py-3">
                                <span class="font-mono text-white">{{ $order->reference }}</span>
                            </td>
