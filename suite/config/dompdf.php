...
return [
    ...
    */
    ...
    'options' => [
         ...
         * @var bool
         *
         * Enabled here deliberately: every document view is authored by us
         * (invoice/receipt/contract/etc. Blade templates) — none of them ever
         * render arbitrary user- or client-supplied HTML — so the "untrusted
         * document" risk this flag guards against doesn't apply. It's what
         * page_text() (used for "Page X of Y" and continuation labels, see
         * suite/docs/document-design-standard.md §9) depends on.
         */
        'enable_php' => true,
