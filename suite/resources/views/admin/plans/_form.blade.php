...
<div class="px-6 py-5 space-y-5">
    ...
    <div>
        ...
        <textarea name="description" rows="2"
                  class="w-full bg-slate-700 border border-slate-600 text-slate-100 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-[#0078D4]">{{ old('description', $plan->description ?? '') }}</textarea>
    </div>
    ...
    <div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
            ...
            <label class="flex items-center gap-3 px-3 py-2.5 rounded-lg border border-slate-700 hover:border-[#0078D4] cursor-pointer transition-colors">
