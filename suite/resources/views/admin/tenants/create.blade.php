    ...
    <div class="max-w-2xl">
        <form action="{{ route('admin.tenants.store') }}" method="POST" class="space-y-6">
            ...
            <div class="bg-slate-800 rounded-2xl border border-slate-700 p-5">
                <h2 class="text-sm font-semibold text-[#D4AF37] mb-4">Business Details</h2>
                <div class="space-y-4">
                    <div class="grid sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select name="industry" class="w-full bg-slate-700 border border-slate-600 text-white text-sm rounded-xl px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-[#0078D4]">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-1">
                                <input type="text" name="subdomain" value="{{ old('subdomain') }}"
                                       ...
                                       class="flex-1 bg-slate-700 border border-slate-600 text-white text-sm rounded-xl px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-[#0078D4]">
            ...
            <!-- Owner Account -->
            <div class="bg-slate-800 rounded-2xl border border-slate-700 p-5">
                <h2 class="text-sm font-semibold text-[#D4AF37] mb-4">Owner Account</h2>
                <div class="space-y-4">
                    <div class="grid sm:grid-cols-2 gap-4">
                        <div>
            ...
            <!-- Module Selection -->
            <div class="bg-slate-800 rounded-2xl border border-slate-700 p-5">
                <h2 class="text-sm font-semibold text-[#D4AF37] mb-1">Activate Modules</h2>
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3">
                <button type="submit" class="w-full sm:w-auto bg-[#0078D4] hover:bg-[#002B5B] text-white text-sm font-semibold px-6 py-3 rounded-xl transition-colors">
                    Create Tenant
                </button>
