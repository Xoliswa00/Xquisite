...
<head>
    ...
    <link rel="manifest" href="{{ route('contractor.manifest', $slug) }}">
...
<main class="max-w-3xl mx-auto px-4 py-10">
    <div hidden
         data-install-banner
         data-install-scope="contractor:{{ $slug }}"
         data-android-text="Add {{ $tenant->name }} to your home screen for one-tap access and job alerts."
         data-ios-text='Add {{ $tenant->name }} to your Home Screen to get notified about new jobs: tap Share, then "Add to Home Screen".'
