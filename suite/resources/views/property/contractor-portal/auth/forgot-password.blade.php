...
<div class="max-w-md mx-auto space-y-6">
    ...
    <div class="bg-white rounded-2xl border border-slate-200 p-8">
        <form method="POST" action="{{ route('contractor.password.email', $slug) }}" class="space-y-5">
            @csrf
            <div>
    ...
    <p class="text-center text-sm">
        <a href="{{ route('contractor.login', $slug) }}" class="text-slate-400 hover:text-slate-600">&larr; Back to sign in</a>
    </p>
</div>
@endsection
