...
<div class="max-w-md mx-auto space-y-6">
    ...
    <div class="bg-white rounded-2xl border border-slate-200 p-8">
        <form method="POST" action="{{ route('contractor.login.post', $slug) }}" class="space-y-5">
            @csrf
            <div>
            ...
            <div>
                <div class="flex items-center justify-between mb-1">
                    ...
                    <a href="{{ route('contractor.password.request', $slug) }}" class="text-xs text-[#0078D4] hover:text-[#0065B8]">Forgot password?</a>
                </div>
