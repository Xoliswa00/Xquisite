        ...
        <nav class="flex-1 px-3 py-4 space-y-1 text-sm overflow-y-auto">
            ...
            @if($authTenant)
                ...
                <a href="{{ route('website.templates.index') }}"
                   class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-800 {{ request()->routeIs($websiteRoutes) ? 'bg-slate-800 text-white' : 'text-slate-400 hover:text-white' }}">
            ...
            @if($authTenant && $authTenant->hasModule('ecommerce'))
                <div class="pt-2 border-t border-slate-800 mt-2">
                    ...
                    <a href="{{ route('store.settings') }}"
                       class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-800 {{ request()->routeIs($storeSettingsRoutes) ? 'bg-slate-800 text-white' : 'text-slate-400 hover:text-white' }}">
                ...
                @can('manage-tenants')
                    <div class="pt-2 border-t border-slate-800 mt-2">
                        ...
                        <a href="{{ route('admin.templates.index') }}"
                           class="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-slate-800 {{ request()->routeIs('admin.templates.*') ? 'bg-slate-800 text-white' : 'text-slate-400 hover:text-white' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 12a1 1 0 011-1h6a1 1 0 011 1v7a1 1 0 01-1 1H5a1 1 0 01-1-1v-7zM14 12a1 1 0 011-1h4a1 1 0 011 1v7a1 1 0 01-1 1h-4a1 1 0 01-1-1v-7z"/></svg>
                            Website Templates
                        </a>
