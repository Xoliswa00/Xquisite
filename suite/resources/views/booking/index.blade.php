...
<div class="hidden lg:block">
    ...
    {{-- Only the order summary pins to the viewport — kept separate from the
         informational cards below so it can never get pushed out of view
         if those cards grow taller than the screen. --}}
    ...
    </div>{{-- end informational cards --}}
</div>{{-- end sidebar --}}

</div>{{-- end two-column --}}

{{-- ── MOBILE: Location (below services, hidden on desktop) ── --}}
@if($tenant->address)
