            ...
            <form method="POST" action="{{ route('suppliers.store') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="address" rows="2"
                              class="w-full bg-slate-700 border border-slate-600 text-slate-100 text-sm rounded-lg px-3 py-2 focus:outline-none focus:ring-1 focus:ring-[#0078D4]">{{ old('address') }}</textarea>
                </div>

                <div>
                    <label class="block text-sm font-medium text-slate-300 mb-1">Notes</label>
                    <textarea name="notes" rows="2"
                              class="w-full bg-slate-700 border border-slate-600 text-slate-100 text-sm rounded-lg px-3 py-2 focus:outline-none focus:ring-1 focus:ring-[#0078D4]">{{ old('notes') }}</textarea>
                </div>
                ...
                <div class="flex items-center gap-3 pt-2">
                    <button type="submit" class="bg-[#0078D4] hover:bg-[#0078D4] text-white text-sm px-6 py-2 rounded-lg">Add Supplier</button>
