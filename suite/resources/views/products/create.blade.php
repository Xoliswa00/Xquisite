        ...
        <div class="bg-slate-800 rounded-xl p-6">
            <form method="POST" action="{{ route('products.store') }}" class="space-y-4">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <input type="checkbox" name="is_available_online" id="is_available_online" value="1" {{ old('is_available_online') ? 'checked' : '' }}
                           class="rounded bg-slate-700 border-slate-600 text-[#0078D4] focus:ring-[#0078D4]">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="reorder_quantity" value="{{ old('reorder_quantity', 0) }}" min="0"
                               class="w-full bg-slate-700 border border-slate-600 text-slate-100 text-sm rounded-lg px-3 py-2 focus:outline-none focus:ring-1 focus:ring-[#0078D4]"
                               placeholder="e.g. 20">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="supplier_sku" value="{{ old('supplier_sku') }}"
                               class="w-full bg-slate-700 border border-slate-600 text-slate-100 text-sm rounded-lg px-3 py-2 focus:outline-none focus:ring-1 focus:ring-[#0078D4]"
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3 pt-2">
                    <button type="submit" class="w-full sm:w-auto bg-[#0078D4] hover:bg-[#0078D4] text-white text-sm px-6 py-2 rounded-lg">Add Product</button>
