@props(['flyoutKey', 'label'])
<div x-show="mobileFlyout === '{{ $flyoutKey }}'" x-cloak x-transition.duration.120ms
     @click.away="mobileFlyout = null"
     class="absolute left-full top-0 ml-2 w-60 max-h-[calc(100vh-2rem)] overflow-y-auto bg-slate-900 border border-slate-800 rounded-2xl shadow-xl p-3 z-50 text-sm">
