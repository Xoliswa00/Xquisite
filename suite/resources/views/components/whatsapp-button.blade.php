...
<a href="https://wa.me/{{ $wa }}?text={{ $msg }}"
   ...
   class="fixed bottom-20 sm:bottom-6 right-4 sm:right-6 z-50 w-12 h-12 sm:w-14 sm:h-14 bg-[#25D366] hover:bg-[#20b858] rounded-full shadow-lg flex items-center justify-center transition-transform hover:scale-110">
