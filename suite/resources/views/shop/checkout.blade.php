            ...
            <div class="grid lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-4">
                        ...
                        <div class="grid sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="customer_name" required
                                       ...
                                       class="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#0078D4] @error('customer_name') border-red-400 @enderror"
                            ...
                            <div>
                                ...
                                <input type="tel" name="customer_phone"
                                       ...
                                       class="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#0078D4]"
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <input type="email" name="customer_email" required
                                       ...
                                       class="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#0078D4] @error('customer_email') border-red-400 @enderror"
                    ...
                    <div class="bg-white rounded-2xl border border-gray-200 p-5">
                        ...
                        <div class="grid sm:grid-cols-2 gap-3">
                            <label class="flex items-start gap-3 p-4 border-2 rounded-xl cursor-pointer transition-colors"
                                   :class="fulfillment === 'collection' ? 'border-[#0078D4] bg-[#F0F7FF]' : 'border-gray-200'">
                                <input type="radio" name="fulfillment_type" value="collection"
                                       x-model="fulfillment" class="mt-0.5 accent-[#0078D4]">
                                <div>
                            ...
                            <label class="flex items-start gap-3 p-4 border-2 rounded-xl cursor-pointer transition-colors"
                                   :class="fulfillment === 'delivery' ? 'border-[#0078D4] bg-[#F0F7FF]' : 'border-gray-200'">
                        ...
                        <div x-show="fulfillment === 'delivery'" x-transition class="mt-4 space-y-3">
                            <div>
                                ...
                                <input type="text" name="address_line1"
                                       ...
                                       class="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#0078D4] @error('address_line1') border-red-400 @enderror"
                    ...
                    <div class="bg-white rounded-2xl border border-gray-200 p-5">
                        ...
                        <textarea name="notes" rows="3"
                                  class="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-[#0078D4] resize-none"
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-2xl border border-gray-200 p-5 sticky top-24">
                        ...
                        <button type="submit"
                                class="mt-5 w-full bg-[#0078D4] hover:bg-[#002B5B] text-white font-semibold py-3 rounded-xl text-sm transition-colors"
