...
<head>
    ...
    <title>@yield('title') — Xquisite Creations</title>
...
<body>
    ...
    <footer>
        &copy; {{ date('Y') }} Xquisite Creations
        <br>
        <span style="display:inline-flex;align-items:center;gap:6px;margin-top:6px;">
            <img src="/img/android-icon-96x96.png" alt="Xquisite Creations" style="height:16px;width:16px;border-radius:4px;">
